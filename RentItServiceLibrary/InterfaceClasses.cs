namespace RentItServiceLibrary {
	...
	public class PublisherAccount : Account {
		...
		public PublisherAccount(string userName, string fullName, string email, string hashedPassword, string publisherName, MediaItems publishedItems) : base(userName, fullName, email, hashedPassword) {

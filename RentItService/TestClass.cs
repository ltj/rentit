...
namespace RentItService
{
    ...
    public class TestClass
    {
        ...
        public Account ValidateCredentials(AccountCredentials credentials)
        {
            ...
            return RentItService.Account.ValueOf(account);
        }
        ...
        /// <returns></returns>
        public static bool CreateNewUser(RentItService.Account newAccountData)
        {
            DatabaseDataContext db = new DatabaseDataContext();
        ...
        public static void Main()
        {
            try
            {
                CreateNewUser(new RentItService.Account("hulemand", "Hulebo 23", "hule@hjem.dk", "hulemis"));
            }
